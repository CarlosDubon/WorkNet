       ...
       switch ($Noti[$i]['Tipo']){
            case 1:
                ...
                $noti.='<div class="alert alert-dismissible alert-info">
                          ...
                          The user <strong>'.$Noti[$i]['user_idCuenta'].'</strong>  is following you. <a href="./agregarAmigo.php?idCuenta='.$Noti[0]['cuenta_idCuenta'].'" class="alert-link">Follow?</a> <strong id="de">'.substr($Noti[0]['Fecha'],0,-9).'</strong>
                        </div>';
            break;
            case 2:
