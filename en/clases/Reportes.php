...
class Reportes{
    ...
    public function reporteUsuario(){
        ...
        for($i=0; $i<count($resul); $i++){
            ...
            $pdf->SetXY($x+156, $y);
            if($resul[$i]['Estado'] == '0'){
                $pdf->MultiCell(22, 7, 'Deactive',1,1,0);
            }else{
    ...
    public function reportesEventos(){
        ...
        $y = $pdf->GetY();
        $pdf->SetXY($x, $y = 120);
        $pdf->MultiCell(19,7, 'ID', 1);
        $pdf->SetXY($x + 19,$y);
        $pdf->MultiCell(22,7, 'User', 1);
        $pdf->SetXY($x +41,$y);
        $pdf->MultiCell(35,7, 'Start', 1);
        $pdf->SetXY($x + 76,$y);
        $pdf->MultiCell(35,7,('End'), 1);
        $pdf->SetXY($x + 111,$y);
