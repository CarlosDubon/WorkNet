...
class Evento {
    ...
    if ($date <= $FechaIni){
        if($FechaIni <= $FechaFin){
            ...
            $utilidades->mostrarMensaje('Sorry! The event can not end before it started!');
        }
            }else{
    ...
    if ($date <= $FechaIni){
        if($FechaIni <= $FechaFin){
            ...
            $utilidades->mostrarMensaje('Lo sentimos, el evento no puede empezar antes de que finalice');
                    ...
                    $utilidades->mostrarMensaje('Sorry! Please check the dates and the hours!');
            }
    ...
    public function eliminarEvento($id){
        ...
        $utilidades->mostrarMensaje('The event was successfully deleted!');
    }
}
