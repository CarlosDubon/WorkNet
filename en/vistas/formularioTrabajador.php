<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><p class="text-center">Sign Up a Worker</p></h3>
    </div>
    <div class="panel-body">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control login-field" id="usuario" maxlength="10" name="user" placeholder="User" required />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="form-group">
        ...
        <div class="row">
          ...
          <div id="val"></div>
            ...
            <div class="form-group">
                <p class="text-center">
                <input type="submit" id="btn" value="Register" class="btn btn-primary btn-lg btn-warning">
