<div class="panel panel-primary">
 ...
 <form method="POST" action="../controladores/guardarCurriculum.php">
    <div class="panel-body">
        ...
        <input type="text" class="form-control" name="name" onkeypress="return numeros(event)" placeholder="Name" Required>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <div class="panel-body">
        ...
        <div class="col-lg-6">
            <div class="panel-body">
                ...
                <input type="tel" name="cel" maxlength="9"  onkeydown="mascara(this,'-',patronCel,true)" class="form-control" placeholder="Cellphone">
            </div>
        </div>
    </div>
    <div class="panel-body">
