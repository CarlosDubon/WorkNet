        ...
        <form action="./recuperar.php" method="POST">
            <div class="login-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control login-field" name="email" placeholder="Email" id="login-name" />
                    <label class="login-field-icon" for="login-name"></label>
                </div>
                <div id="divcen">
                    <center>
                        <input class="btn btn-primary btn-lg btn-danger" type="submit" value="Recover Password">
                        </div>
