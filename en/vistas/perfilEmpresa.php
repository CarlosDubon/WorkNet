    ...
    <div class="panel panel-default">
        ...
        <div class="panel panel-default" id="az">
          <div class="panel-body">
            ...
            <b>User:</b> {{Usuario}} <br>
            <b>Web Site:</b> {{Web}} <small id="de"><a href =""  data-toggle="modal" data-target="#ChangeWeb">Edit<i class="fa fa-pencil"> </i></a></small><br>
            <b>Fundation Date:</b> {{Fun}}<br>
            <b>Category:</b> {{Categoria}} <small id="de"><a href =""  data-toggle="modal" data-target="#ChangeCat">Edit<i class="fa fa-pencil"> </i></a></small>
      ...
      <div class="modal-body">
        <form action="./cambiarCorreo.php" method="POST">
          <div class="form-group">
             <label class="control-label" for="disabledInput">Old Email</label>
