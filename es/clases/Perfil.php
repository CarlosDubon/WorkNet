...
class Perfil {
    ...
    public function mostrarPerfil() {
     ...
     public function subirFoto($archivo){
                ...
                $utilidades-> mostrarMensaje('¡La foto se actualizó correctamente!');
    ...
    public function editarCorreo($editor){
        ...
        if($resultado)
            $utilidades-> mostrarMensaje('¡El correo se actualizó correctamente!');
        $utilidades -> Redireccionar('controladores/perfil_Mostrar.php');
    }
    ...
    public function editarWeb($editor){
        ...
        if($resultado)
            $utilidades-> mostrarMensaje('¡El correo se actulizó correctamente!');
        $utilidades -> Redireccionar('controladores/perfil_Mostrar.php');
    }
    ...
    public function editarCategoria($editor){
        ...
        $resultado = $bd->modificarRegistro($tabla,$cambio,$where);
        if($resultado)
            $utilidades->mostrarMensaje('¡Usted se cambió de categoría!');
        else
