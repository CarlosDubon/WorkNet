...
class Curriculum {
    ...
    public function crearCurriculum($datos){
        ...
        if($result){
            ...
            $utilidades->mostrarMensaje("El currículum se creó exitosamente");
            ...
            $c.='<div class="panel panel-default">
                  <div class="panel-heading">'.$C[$i]['Nombre_Completo'].'</div>
                    <div class="panel-body">
                        <p>Número Telefónico: '.$C[$i]['Telefono'].'<br>Celular:'.$C[$i]['Celular'].'<br>
    ...
    public function editarCurriculum($datos){
        ...
        if($result){
            $utilidades->mostrarMensaje('El currículum se editó correctamente');
            $utilidades->Redireccionar('controladores/verCurriculum.php');
        }else{
             $utilidades->mostrarMensaje('¡Lo sentimos! Ocurrió un problema, por favor intente de nuevo');
