...
class Usuario {
    ...
    public function mostrarUsuarioTrabajador(){
        ...
        $acciones = ' <center><a  href="./recuperarClave.php?idCuenta={{id}}" title="Restablecer Contraseña" onclick ="confirmAccion()" class = "btn btn-info" id="acciones" ><span class="fui-new"></span></a>';
        $acciones .= ' <a href="./eliminarUsuario.php?idCuenta={{id}}" title="Eliminar Usuario" onclick ="onclick ="confirmAccion()" class="btn btn-danger" id="acciones"><span class="fui-trash"></span></a></center>';
    ...
    public function mostrarListaUsuarios(){
        ...
        $acciones = '<center><a href="./activarUsuario.php?idCuenta={{id}}" title="Activar Usuario" onclick="confirmAccion()" class="btn btn-success" id="acciones"><span class="fui-check"></span></a>';
        $acciones .= ' <a href="./desactivarUsuario.php?idCuenta={{id}}" title="Desactivar Usuario" onclick="confirmAccion()" class = "btn btn-danger" id="acciones"><span class="fui-cross"></span></a>';
        $acciones .= ' <a  href="./recuperarClave.php?idCuenta={{id}}" title="Restablecer Contraseña" onclick="confirmAccion()" class = "btn btn-info" id="acciones" ><span class="fui-new"></span></a>';
        $acciones .= ' <a href="./eliminarUsuario.php?idCuenta={{id}}" title="Eliminar Usuario" onclick="confirmAccion()" class="btn btn-danger" id="acciones"><span class="fui-trash"></span></a></center>';
    ...
    public function mostrarListaEmpresarios(){
        ...
        $acciones .= ' <a href="./desactivarUsuario.php?idCuenta={{id}}" title="Desactivar Usuario" onclick="confirmAccion()" class = "btn btn-danger" id="acciones"><span class="fui-cross"></span></a>';
        $acciones .= ' <a  href="./recuperarClave.php?idCuenta={{id}}" title="Restablecer Contraseña" onclick="confirmAccion()" class = "btn btn-info" id="acciones" ><span class="fui-new"></span></a>';
        $acciones .= ' <a href="./eliminarUsuario.php?idCuenta={{id}}" title="Eliminar Usuario" onclick="confirmAccion()" class="btn btn-danger" id="acciones"><span class="fui-trash"></span></a>';
    ...
    public function mostrarFormularioCambiarContEmpre(){
        ...
        $oldPass = $datosContraEmpre['oldpass'];
        $tabla = 'cuenta';
        $cambio = 'Password ="'.$newpass.'"';
        $where = 'idCuenta ="'.$id.'"';
